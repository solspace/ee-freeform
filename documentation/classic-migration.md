...
If there are any issues you suspect are a bug, please let us know through a [support ticket](https://docs.solspace.com/expressionengine/freeform/v1/support.html) before proceeding any further. We may be able to resolve an issue and you can try running migration again.
