...
class Freeform_SubmissionsController extends BaseController
{
    /**
    ...
    public function actionSave()
    {
        ...
        $submissionModel = $this->getSubmissionsService()->getSubmissionById($submissionId);

        $submissionModel->setAttributes($post);
        $submissionModel->getContent()->title = craft()->request->getPost('title', $submissionModel->title);

        if ($this->getSubmissionsService()->save($submissionModel)) {
    ...
    public function actionDelete()
    {
        ...
        $this->getSubmissionsService()->deleteById($submissionId);
        $this->returnJson(['success' => true]);
    }
     ...
     */
    private function getSubmissionsService()
    {
