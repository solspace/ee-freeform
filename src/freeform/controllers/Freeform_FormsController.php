...
class Freeform_FormsController extends BaseController
{
    /**
    ...
    public function actionEdit(array $variables = [])
    {
        ...
        $templateVariables = [
            ...
            "crumbs"                 => [
                ...
                [
                    ...
                    "url"   => UrlHelper::getUrl(
                        "freeform/forms/" . ($formId ? $formId : "new")
                    ),
                ],
            ],
            ...
            "statuses"               => $this->getEncodedJson($this->getStatusService()->getAllStatuses(false)),
            "solspaceFormTemplates"  => $this->getEncodedJson($this->getSettingsService()->getSolspaceFormTemplates()),
            ...
            "canManageFields"        => PermissionsHelper::checkPermission(PermissionsHelper::PERMISSION_FIELDS_MANAGE),
            "canManageNotifications" => PermissionsHelper::checkPermission(
                PermissionsHelper::PERMISSION_NOTIFICATIONS_MANAGE
            ),
            "canManageSettings" => PermissionsHelper::checkPermission(PermissionsHelper::PERMISSION_SETTINGS_ACCESS),
        ];
     ...
     */
    private function getFilesService()
    {
     ...
     * @return string
     */
    private function getEncodedJson($data)
    {
