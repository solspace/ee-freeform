...
class Freeform_NotificationsController extends BaseController
{
    ...
    public function actionSave()
    {
        ...
        if ($this->getNotificationService()->save($notification)) {
            ...
            if (craft()->request->isAjaxRequest()) {
                ...
                craft()->urlManager->setRouteVariables(['notification' => $notification, "errors" => $notification->getErrors()]);
            }
        }
    }
