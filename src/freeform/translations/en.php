...
return [
    ...
    "Provide a relative path to the Craft root folder where your custom formatting templates directory is. This allows you to use Twig templates for your form formatting, and helps Composer locate these files to assign one of them to a form." => "Provide a relative path to the Craft root folder where your custom formatting templates directory is. This allows you to use Twig templates for your form formatting, and helps Composer locate these files to assign one of them to a form.",
    ...
    "Select the display order for the list of available fields in Composer" => "Select the display order for the list of available fields in Composer",
